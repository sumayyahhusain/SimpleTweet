...
<img src='SimpleTweetWalkthrough3.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
The most difficult part was getting approved for a Twitter Developer account. I had to redo the application four times to get approved. I later realized that the APi Keys that were given to us with the creation of the Developer account didn't work. The keys provided on CodePath were to be used (which would have been nice to know at the beginning). My emulator still runs slowly but there's not much I can do about that.
